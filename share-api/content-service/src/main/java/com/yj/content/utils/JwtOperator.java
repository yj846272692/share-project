...
public class JwtOperator {
    ...
    public static void main(String[] args) {
        ...
        objectObjectMap.put("role", "users");
        String s = jwtOperator.generateToken(objectObjectMap);
        System.out.println(s);
//        eyJhbGciOiJIUzI1NiJ9.eyJyb2xlIjoidXNlcnMiLCJpYXQiOjE2NjQ4NjczNjcsImV4cCI6MTY2NjA3Njk2N30.yXpT7W1lR4NU3ep12MSC7CrCBdKcJm0CYtK6mHr64fI
    }
}
